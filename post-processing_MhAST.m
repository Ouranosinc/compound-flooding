...
selected_copula = 'Raftery';
DesignRP = 100;
%%
cd(fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,horizon,serie,'\Results'))
...
if strcmp(serie,'WLcondQ')
    ...
    if strcmp(horizon,'historic')
        f = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'historic',serie,'\Results\MhAST_Results.mat');
        load(f);
    elseif strcmp(horizon,'future')
        f = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'future',serie,'\Results\MhAST_Results.mat');
        load(f);
    end
    ...
    [QH_bivariate_allQH,QH_Design,Copula_Pars,desvarnames] = RPBivariate(copula_type,selected_copula,Design_Variables,serie, S,DesignRP,data,handles,Copula_Variables);
    if strcmp(copula_type,'dependent')
...
if strcmp(serie,'WLcondQ')
    f = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'historic',serie,'\Results\MhAST_Results.mat');
    load(f);
    g = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'historic','QcondWL','\Results\MhAST_Results.mat'); 
    load(g,'PD_U2','D_U2');
    save('data.mat')
elseif strcmp(serie,'QcondWL')
    ...
    f = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'historic',serie,'\Results\MhAST_Results.mat');
    load(f);
    g = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'historic','WLcondQ','\Results\MhAST_Results.mat'); 
    load(g,'PD_U1','D_U1');
    save('data.mat')
end
end
...
if strcmp(serie,'WLcondQ')
    f = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'future',serie,'\Results\MhAST_Results.mat');
    load(f);
    g = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'future','QcondWL','\Results\MhAST_Results.mat'); 
    load(g,'PD_U2','D_U2');
    save('data.mat')
elseif strcmp(serie,'QcondWL')
    ...
    f = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'future',serie,'\Results\MhAST_Results.mat');
    load(f);
    g = fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Rehaussement_marine\MhAST_Ver02.05\',outlet,'future','WLcondQ','\Results\MhAST_Results.mat'); 
    load(g,'PD_U1','D_U1');
    save('data.mat')
end
end
...
function [QH_bivariate,QH_Design,Copula_pars,desvarnames] = RPBivariate(copula_type,selected_copula,Design_Variables,serie,historic,DesignRP,data,handles,Copula_Variables)
if strcmp(copula_type,'dependent')
    desvarnames = {'Q','H'};
