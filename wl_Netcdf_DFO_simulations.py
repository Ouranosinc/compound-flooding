...
"""
This script transforms the river flow and water level time series of DFO simulations from multiple csv files to one single Netcdf.
...
Output: Netcdf file containing the river flow and water level time series
...
def Create_netcdf_wl(period,rivers,outfile):
    if period == 'historic':
...
if __name__ == "__main__":
    ...
    Create_netcdf_wl('historic',rivers,outfile)
