...
% 
% get(gcf,'Position')
figure('Position',[456    62   832   916]);
for i=1:11
...
%     labels = {'Batiscan','Becancour','Saint Maurice','Nicolet','du Loup','Maskinonge','Saint Francois','Yamaska','Richelieu','Assomption','Chateauguay','Moulin'};
    ...
    UHF =[3,10,43,15,16,7,7,9,17,5,4];
    ...
    colormap(jet)
    aa = sprintf('%.2f',tau(i));
    title([labels{i} + ":" + UHF(i)]);
    axis([X_Axis Y_Axis])
    rr = Design_Variables.DesignValue_MaxDens.DesignRP_ind(copula_type(i));
%     text(1.02*X_Axis(2),1.02*Y_Axis(1),num2str(rr),'Color','black','FontSize',10,'fontweight','bold')
...
%         cb.Label.String = 'Probability Density';
        cb.Label.String = 'Densité de probabilité';
...
%         ylabel('Water Level (m)');
    ...
    plot(QH(1), QH(2), 'go', 'markersize', 6, 'linewidth', 2, 'markeredgecolor', 'r', 'markerfacecolor', 'r');
    hold on
...
for i=1:11
    ...
    outlet = {'Batiscan','Becancour','Saint_Maurice','Nicolet','du_Loup','Maskinonge','Saint_Francois','Yamaska','Richelieu','Assomption','Chateauguay'};
    labels = {'Batiscan','Becancour','Saint Maurice','Nicolet','du Loup','Maskinonge','Saint Francois','Yamaska','Richelieu','Assomption','Chateauguay'};
    copula_type = [4,1,23,18,4,4,18,8,8,4,3];
    tau =[0.27,0.2,0.17,0.17,0.32,0.34,0.25,0.17,0.25,0.4,0.23];
    UHF =[4,4,5,8,4,3,13,18,24,4,2];
...
%     outlet = {'Batiscan','Becancour','Saint_Maurice','Nicolet','du_Loup','Maskinonge','Saint_Francois','Yamaska','Richelieu','Assomption'};
    labels = {'WLcondQ','QcondWL'};
    copula_type = [6,6];
    fnames_future = {'U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results\RivSud\future\WLcondQ\100\Results\future_WLcondQ_RivSud.mat',...
        'U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results\RivSud\future\QcondWL\100\Results\future_QcondWL_RivSud.mat'};
    
    fnames_historic = {'U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results\RivSud\historic\WLcondQ\100\Results\historic_WLcondQ_RivSud.mat',...
        'U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results\RivSud\historic\QcondWL\100\Results\historic_QcondWL_RivSud.mat'};
    
    pth = {'U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results\RivSud\future\WLcondQ\100\Results\MhAST_Results.mat',...
       'U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results\RivSud\future\QcondWL\100\Results\MhAST_Results.mat'}; 
...
%             cd(fullfile('U:\Dossier_travail\705300_rehaussement_marin\3- Data\Results',outlet{i},'historic',serie,'100\Results'))
%             load ('MhAST_Results.mat')
            QH(1:7,1) = [historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,1),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,3),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,5),...
                historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,7),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,9),...
                historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,11),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,13)];
            
            QH(1:7,2) = [historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,2),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,4),...
                historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,6),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,8),...
                historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,10),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,12),historic.Bivariate.DesVarValues.RP100.QH_bivariate(1,14)];
            
            scatter(QH(:,1), QH(:,2),  'markeredgecolor', 'k', 'markerfacecolor', 'k');
            hold on
            
            
            QH_future(1:7,1) = [future.Bivariate.DesVarValues.RP100.QH_bivariate(1,1),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,3),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,5),...
                future.Bivariate.DesVarValues.RP100.QH_bivariate(1,7),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,9),...
                future.Bivariate.DesVarValues.RP100.QH_bivariate(1,11),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,13)];
            
            QH_future(1:7,2) = [future.Bivariate.DesVarValues.RP100.QH_bivariate(1,2),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,4),...
                future.Bivariate.DesVarValues.RP100.QH_bivariate(1,6),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,8),...
                future.Bivariate.DesVarValues.RP100.QH_bivariate(1,10),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,12),future.Bivariate.DesVarValues.RP100.QH_bivariate(1,14)];
