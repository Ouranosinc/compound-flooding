function merge_mats_LOT12 (pth_base, outlet,pth_out)
...
fname1 = fullfile(pth_base,outlet,'historic','WLcondQ','\Results\',name1);
fname2 = fullfile(pth_base,outlet,'historic','QcondWL','\Results\',name2);
fname3 = fullfile(pth_base,outlet,'future','WLcondQ','\Results\',name3);
fname4 = fullfile(pth_base,outlet,'future','QcondWL','\Results\',name4);
